...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <div className="rounded-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm m-4">
        ...
        <p style={{ marginBottom: '16px' }}><strong>7. File Your California Notary Bond and Oath: </strong>You must file your notary bond and oath within 30 days of the start date of your notary commission. Bring the following items to your county clerk&apos;s office:</p>
        <ul>
          <li>Original Bond</li>
