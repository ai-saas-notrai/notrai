  ...
  return (
    <div>
      <div className="mb-8 space-y-4">
        <h2 className="text-2xl md:text-4xl font-bold text-center m-2">
          Become a California Notary Public with Notrai
        </h2>
        <p className="text-muted-foreground font-light text-sm md:text-lg text-center m-2">
        Your AI-Powered Copilot for a Smarter Path to Compliance and Expertise.
        </p>


      <div className="rounded-lg border max-w-1xl p-8 px-4 md:px-8 focus-within:shadow-sm m-4">
        <h1 className="text-2xl md:text-2xl font-bold text-gray-900 mb-6" >How to Become a California Notary Public</h1>
